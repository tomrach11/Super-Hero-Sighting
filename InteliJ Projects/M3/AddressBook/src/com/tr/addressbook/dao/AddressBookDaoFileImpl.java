...
public class AddressBookDaoFileImpl implements AddressBookDao {
    ...
    @Override
    public Profile addAddress(Profile profile, Address address) throws AddressBookDaoException {
        readFile();
        Profile newProfile = profile;
        newProfile.setAddress(address);
        Profile addedProfile = addresses.put(newProfile.getLastName(), newProfile);
        writeFile();
        return addedProfile;
    }

    @Override
    public Profile removeAddress(String lastName) throws AddressBookDaoException {
        readFile();
        Profile profile = addresses.remove(lastName);
        writeFile();
        return profile;
    }
